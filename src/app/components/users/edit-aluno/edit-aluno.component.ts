...
export class EditAlunoComponent implements OnInit {
  ...
  carregarDados(p: User) {
    ...
    this.user = p;
     ...
     this.signupForm.controls['curso'].setValue(p.curso);
     ...
     this.signupForm.controls['pathProfMateria0'].setValue(p.pathProfMateria0);
     this.signupForm.controls['pathProfMateria1'].setValue(p.pathProfMateria1);
     this.signupForm.controls['pathProfMateria2'].setValue(p.pathProfMateria2);
     this.signupForm.controls['pathProfMateria3'].setValue(p.pathProfMateria3);
     this.signupForm.controls['pathProfMateria4'].setValue(p.pathProfMateria4);
     this.signupForm.controls['pathProfMateria5'].setValue(p.pathProfMateria5);
     this.signupForm.controls['pathProfMateria6'].setValue(p.pathProfMateria6);
     this.signupForm.controls['pathProfMateria7'].setValue(p.pathProfMateria7);
